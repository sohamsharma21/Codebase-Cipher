...
import { Wand2, Copy, Check, FileCode, Loader2, Zap, BookOpen, Package, Tag, Gauge } from 'lucide-react';
...
export default function RightPanel({ selectedFile, files, isDemo }: RightPanelProps) {
    ...
    <div className="w-[360px] shrink-0 border-l border-border bg-card flex flex-col h-full overflow-hidden">
      ...
      <div className="p-3 border-b border-border">
        <div className="flex items-center gap-2 mb-2">
          <Wand2 className="w-3.5 h-3.5 text-purple" />
